...
//   (void) last_call_time;
//   if (timer != NULL) {
//     // msg.data.data[0] = car.totalThetaRight;
//     // msg.data.data[1] = car.totalThetaLeft;
//     // msg.data.size = 2;
//     msg.data = int(car.totalThetaRight);
//     // msg.data += 1;
...
void loop() {
  ...
  if (state == AGENT_CONNECTED) {
    ...
    // car.moving = true;
    car.forward(100, 88, 98, publisher, msg);
    // delay(200);
...
// void Movement::forwardWithoutControl(double distance, int rightServoSpeed, int leftServoSpeed, rcl_publisher_t &publisher, std_msgs__msg__Int32 &msg)
// {
//     PcontrolRight = 0;
//     PcontrolLeft = 0;
//     servoRight.attach(pinServoRight);
